...
class Point(object):
    ...
    def move_to(self, x, y):
        self.moveDis += math.sqrt(((x - self.x) ** 2) + ((y - self.y) ** 2))
        self.x = x
        self.y = y
        self.moves += 1

    def move_by(self, dx, dy):
        self.moveDis += math.sqrt((dx ** 2) + (dy ** 2))
        self.x += dx
        self.y += dy
        self.moves += 1
    ...
    def get_distance_from_start(self):
        return math.sqrt(((self.x - self.origX) ** 2) + ((self.y - self.origY) ** 2))

    def get_distance_traveled(self):
        return self.moveDis

    def closer_to(self, p2, p3):
        dis3 = math.sqrt(((self.x - p3.x) ** 2) + ((self.y - p3.y) ** 2))
        dis2 = math.sqrt(((self.x - p2.x) ** 2) + ((self.y - p2.y) ** 2))
...
def run_test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # d: 4.  Follow the same instructions as in d 3 above,
...
def run_test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # d: 5.  Follow the same instructions as in d 3 above,
...
def run_test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # d: 6.  Follow the same instructions as in d 3 above,
...
def run_test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # d: 7.  Follow the same instructions as in d 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # d: 8.  Follow the same instructions as in d 3 above,
...
def run_test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # d: 9.  Follow the same instructions as in d 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # D: 10.  Follow the same instructions as in D 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # d: 11.  Follow the same instructions as in d 3 above,
...
def run_test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # d: 12.  Follow the same instructions as in d 3 above,
...
def run_test_halfway_to():
    ...
    """
    # ------------------------------------------------------------------
    # d: 13.  Follow the same instructions as in d 3 above,
